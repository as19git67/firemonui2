        ...
        <v-flex xs12 sm8 md4>
          <v-card class="elevation-12">
            <v-form>
              ...
              <v-layout align-center justify-center>
                <v-text-field id="password" v-model="code" name="password" type="text" autocomplete="off"
                              outlined
                              solo
                              flat
                              persistent-hint
              ...
              <v-card-actions>
                ...
                <v-spacer/>
                <v-btn :disabled="!code || code.length !== 6"  color="primary" dark class="white--text" @click="validateCode()">
                  Code prüfen
                </v-btn>
              </v-card-actions>
            </v-form>
